...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../lib -dynamiclib -stdlib=libc++ -Wl,-rpath,/Users/SiChengTian/Desktop/steersuite-rutgers/build/lib -install_name @rpath/libsteerlib.dylib
